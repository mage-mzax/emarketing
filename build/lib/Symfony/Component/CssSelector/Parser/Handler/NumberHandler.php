...
class Symfony_Component_CssSelector_Parser_Handler_NumberHandler implements Symfony_Component_CssSelector_Parser_Handler_HandlerInterface
{
     ...
     */
    public function __construct(Symfony_Component_CssSelector_Parser_Tokenizer_TokenizerPatterns $patterns)
    {
    ...
    public function handle(Symfony_Component_CssSelector_Parser_Reader $reader, Symfony_Component_CssSelector_Parser_TokenStream $stream)
    {
        ...
        $stream->push(new Symfony_Component_CssSelector_Parser_Token(Symfony_Component_CssSelector_Parser_Token::TYPE_NUMBER, $match[0], $reader->getPosition()));
