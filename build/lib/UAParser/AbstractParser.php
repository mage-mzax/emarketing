...
abstract class UAParser_AbstractParser
{
    /** @var string */
    ...
    {
        $this->_regexes = $_regexes;
    }

    /**
     * Create parser instance
     *
     * Either pass a custom _regexes.php file or leave the argument empty and use the default file.
     *
     * @param string $file
     ...
     * @return array
     */
    protected function tryMatch(array $_regexes, $userAgent)
    {
        foreach ($_regexes as $regex) {
    ...
    protected static function getDefaultFile()
    {
        return static::$defaultFile
            ? static::$defaultFile
            : realpath(__DIR__ . '/../resources') . DIRECTORY_SEPARATOR . '_regexes.php';
    }
}
