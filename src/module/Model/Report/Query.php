...
class Mzax_Emarketing_Model_Report_Query
{
    ...
    protected function _loadDimensionReport()
    {
        ...
        $select->join(array('label' => $this->getTable('report_enum')),
            '`label`.`value_id` = `report`.`value_id`', null);
    ...
    /**
     * Retrieve the sum of all rows and all specfied columns
     * 
