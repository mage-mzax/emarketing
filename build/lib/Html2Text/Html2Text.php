...
class Html2Text_Html2Text {
	...
	static function convert($html) {
		...
		if (!$doc->loadHTML($html)) {
			throw new Html2Text_Html2TextException("Could not load HTML - badly formed?", $html);
		}
	 ...
	 *
	 * This cleaned up document can then be processed as normal through Html2Text_Html2Text.
	 *
