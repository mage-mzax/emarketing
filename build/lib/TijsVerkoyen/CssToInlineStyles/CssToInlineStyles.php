...
class TijsVerkoyen_CssToInlineStyles_CssToInlineStyles
{
    ...
    public function convert($outputXHTML = false)
    {
        ...
        // validate
        if ($this->html == null) {
            throw new TijsVerkoyen_CssToInlineStyles_Exception('No HTML provided.');
        }
    ...
    private function processCSS()
    {
        ...
        foreach ($rules as $rule) {
            ...
            foreach ($selectors as $selector) {
                ...
                $ruleSet['specificity'] = TijsVerkoyen_CssToInlineStyles_Specificity::fromSelector($selector);
