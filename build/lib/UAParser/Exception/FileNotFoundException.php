...
class UAParser_Exception_FileNotFoundException extends Exception
{
    ...
    public static function customRegexFileNotFound($file)
    {
        return new static(
            sprintf(
                'ua-parser cannot find the custom _regexes file you supplied ("%s"). Please make sure you have the correct path.',
                $file
            )
        );
    }
